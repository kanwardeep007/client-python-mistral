...
from kdmistralai._hooks import SDKHooks
...
if TYPE_CHECKING:
    ...
    from kdmistralai.classifiers import Classifiers
    from kdmistralai.embeddings import Embeddings
    from kdmistralai.files import Files
    from kdmistralai.fim import Fim
    from kdmistralai.fine_tuning import FineTuning
    from kdmistralai.models_ import Models
...
class KdMistral(BaseSDK):
    ...
    _sub_sdk_map = {
        ...
        "files": ("kdmistralai.files", "Files"),
        "fine_tuning": ("kdmistralai.fine_tuning", "FineTuning"),
        "batch": ("kdmistralai.batch", "Batch"),
        "chat": ("kdmistralai.chat", "Chat"),
        "fim": ("kdmistralai.fim", "Fim"),
        "agents": ("kdmistralai.agents", "Agents"),
