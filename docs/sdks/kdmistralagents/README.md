...
with KdMistral(
    ...
    res = kd_mistral.beta.agents.create(model="LeBaron", name="<value>")
...
with KdMistral(
    ...
    res = kd_mistral.beta.agents.list(page=0, page_size=20)
...
with KdMistral(
    ...
    res = kd_mistral.beta.agents.get(agent_id="<id>")
...
with KdMistral(
    ...
    res = kd_mistral.beta.agents.update(agent_id="<id>")
...
with KdMistral(
    ...
    res = kd_mistral.beta.agents.update_version(agent_id="<id>", version=157995)
